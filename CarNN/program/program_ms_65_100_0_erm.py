...
def execute(inputs):
	...
	program_edges[("0",2)]= "opclass_0"
	program_edges[("0",1)]= "opclass_0"
	program_edges[("0",0)]= "opclass_0"

	features = feature_defs.retrieve_feature_defs()

	value_map = {} 
	value_map["lug_boot_3"] = features["lug_boot_3"]([("buying",inputs[0]),("maint",inputs[1]),("doors",inputs[2]),("persons",inputs[3]),("lug_boot",inputs[4]),("safety",inputs[5])])
